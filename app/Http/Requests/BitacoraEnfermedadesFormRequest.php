...
class BitacoraEnfermedadesFormRequest extends FormRequest
{
    /**
...
//            'usu_mod_id' => 'required',
    ...
    {
        $data = $this->only(['area_id','persona_id','enfermedad_id','descripcion','accion_id','costo_directo','costo_indirecto','fecha','anio','mes','turno_id','entity_id','usu_alta_id','usu_mod_id']);
