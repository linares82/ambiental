...
class Probabilidad extends Model
{
    ...
    */
    ...
    {
        return $this->hasMany('App\Models\AspectosAmbientale','probabilidad_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\LnCaracteristica','probabilidad_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\MImpReal','probabilidad_id','id');
    }
