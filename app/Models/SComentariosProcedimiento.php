...
class SComentariosProcedimiento extends Model
{
     ...
     * @var string
     */
    protected $table = 's_comentarios_procedimientos';
    ...
    */
    ...
    {
        return $this->belongsTo('App\Models\SProcedimiento','s_procedimiento_id','id');
    }
