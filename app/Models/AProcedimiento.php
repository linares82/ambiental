...
class AProcedimiento extends Model
{
    ...
    */
    ...
    /**
     * Get the caProcedimiento for this model.
     */
    public function caProcedimiento()
    {
        return $this->belongsTo('App\Models\CaProcedimiento','procedimiento_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\AComentariosProcedimiento','a_procedimiento_id','id');
    }
