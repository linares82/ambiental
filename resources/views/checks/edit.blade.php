...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('checks.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('checks.check.update', $check->id) }}" id="edit_check_form" name="edit_check_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
