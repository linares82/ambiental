    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('bitacora_pendientes.create') }}</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('bitacora_pendientes.bitacora_pendiente.store') }}" accept-charset="UTF-8" id="create_bitacora_pendiente_form" name="create_bitacora_pendiente_form" class="">
            {{ csrf_field() }}
            @include ('bitacora_pendientes.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('bitacora_pendientes.add') }}">
                    </div>
                </div>
