...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : '{{ trans('files_s_documentos.model_plural') }}' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('files_s_documentos.files_s_documento.update', $filesSDocumento->id) }}" id="edit_files_s_documento_form" name="edit_files_s_documento_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('files_s_documentos.form', [
                                        'filesSDocumento' => $filesSDocumento,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('files_s_documentos.update') }}">
                    </div>
                </div>
            </form>
