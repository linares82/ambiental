...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('ca_tpo_bitacoras.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('ca_tpo_bitacoras.ca_tpo_bitacora.update', $caTpoBitacora->id) }}" id="edit_ca_tpo_bitacora_form" name="edit_ca_tpo_bitacora_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('ca_tpo_bitacoras.form', [
                                        'caTpoBitacora' => $caTpoBitacora,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('ca_tpo_bitacoras.update') }}">
                    </div>
                </div>
            </form>
