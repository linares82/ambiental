...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('cs_elementos_inspeccions.cs_elementos_inspeccion.update', $csElementosInspeccion->id) }}" id="edit_cs_elementos_inspeccion_form" name="edit_cs_elementos_inspeccion_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
