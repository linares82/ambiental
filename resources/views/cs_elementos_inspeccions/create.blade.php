...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('cs_elementos_inspeccions.cs_elementos_inspeccion.store') }}" accept-charset="UTF-8" id="create_cs_elementos_inspeccion_form" name="create_cs_elementos_inspeccion_form" class="">
            {{ csrf_field() }}
