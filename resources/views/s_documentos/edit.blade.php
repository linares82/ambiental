...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('s_documentos.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('s_documentos.s_documento.update', $sDocumento->id) }}" id="edit_s_documento_form" name="edit_s_documento_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            ...
            @include ('s_documentos.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('s_documentos.update') }}">
                    </div>
                </div>
            </form>
