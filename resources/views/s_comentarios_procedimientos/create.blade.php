    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('s_comentarios_procedimientos.create') }}</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('s_comentarios_procedimientos.s_comentarios_procedimiento.store') }}" accept-charset="UTF-8" id="create_s_comentarios_procedimiento_form" name="create_s_comentarios_procedimiento_form" class="">
            {{ csrf_field() }}
            @include ('s_comentarios_procedimientos.form', [
                                        'sComentariosProcedimiento' => null,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('s_comentarios_procedimientos.add') }}">
                    </div>
                </div>
