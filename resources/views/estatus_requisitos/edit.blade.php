...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : '{{ trans('estatus_requisitos.model_plural') }}' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('estatus_requisitos.estatus_requisito.update', $estatusRequisito->id) }}" id="edit_estatus_requisito_form" name="edit_estatus_requisito_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('estatus_requisitos.form', [
                                        'estatusRequisito' => $estatusRequisito,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('estatus_requisitos.update') }}">
                    </div>
                </div>
            </form>
