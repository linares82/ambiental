...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('caracteristicas.model_plural') }}</h4>
            </div>
            
            @ifUserCan('caracteristicas.caracteristica.create')
            <div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('caracteristicas.caracteristica.create') }}" class="btn btn-success btn-xs" title="{{ trans('caracteristicas.create') }}">
			...
			<div class="btn-group btn-group-sm pull-right" role="group">
                <a href="{{ route('caracteristicas.caracteristica.index') }}" class="btn btn-xs" title="Refrescar">
        ...
        @if(count($caracteristicas) == 0)
            <div class="panel-body text-center">
                <h4>{{ trans('caracteristicas.none_available') }}</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="row" >
				<div class="col-md-12">
					<form method="GET" action="{{ route('caracteristicas.caracteristica.index') }}" id="search_form" name="search_form" accept-charset="UTF-8" class="">
						{{ csrf_field() }}
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        @ifUserCan('caracteristicas.caracteristica.show')
                                        <a href="{{ route('caracteristicas.caracteristica.show', $caracteristica->id ) }}" class="btn btn-info btn-xs" title="{{ trans('caracteristicas.show') }}">
                                            <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                                        </a>
                                        @endif
                                        @ifUserCan('caracteristicas.caracteristica.edit')
                                        <a href="{{ route('caracteristicas.caracteristica.edit', $caracteristica->id ) }}" class="btn btn-primary btn-xs" title="{{ trans('caracteristicas.edit') }}">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        </a>
                                        @endif
                                        @ifUserCan('caracteristicas.caracteristica.destroy')
                                        <button type="submit" class="btn btn-danger btn-xs" title="{{ trans('caracteristicas.delete') }}" onclick="return confirm(&quot;{{ trans('caracteristicas.confirm_delete') }}&quot;)">
