...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('clientes.cliente.update', $cliente->id) }}" id="edit_cliente_form" name="edit_cliente_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            ...
            @include ('clientes.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('clientes.update') }}">
                    </div>
                </div>
            </form>
