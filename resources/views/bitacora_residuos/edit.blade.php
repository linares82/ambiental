...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('bitacora_residuos.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('bitacora_residuos.bitacora_residuo.update', $bitacoraResiduo->id) }}" id="edit_bitacora_residuo_form" name="edit_bitacora_residuo_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('bitacora_residuos.form', [
                                        'bitacoraResiduo' => $bitacoraResiduo,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('bitacora_residuos.update') }}">
                    </div>
                </div>
            </form>
