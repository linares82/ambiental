...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('cs_tpo_docs.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('cs_tpo_docs.cs_tpo_doc.update', $csTpoDoc->id) }}" id="edit_cs_tpo_doc_form" name="edit_cs_tpo_doc_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('cs_tpo_docs.form', [
                                        'csTpoDoc' => $csTpoDoc,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('cs_tpo_docs.update') }}">
                    </div>
                </div>
            </form>
