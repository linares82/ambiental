...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Norma' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('normas.norma.update', $norma->id) }}" id="edit_norma_form" name="edit_norma_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            ...
            @include ('normas.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('normas.update') }}">
                    </div>
                </div>
            </form>
