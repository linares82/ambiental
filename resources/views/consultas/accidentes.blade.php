...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <form method="POST" action="{{ route('consultas.consulta.postAccidentes') }}" accept-charset="UTF-8" id="create_condicione_form" name="create_condicione_form" class="">
            {{ csrf_field() }}
        ...
        <div class="form-group col-md-6 {{ $errors->has('accidente_f') ? 'has-error' : '' }}">
            <label for="accidente_f" class="control-label">Accidente de:</label>
            <!--<div class="col-md-10">-->
                <select class="form-control chosen" id="accidente_f" name="accidente_f" required="true">
                            <option value="" style="display: none;"  disabled selected>Seleccionar</option>
                                @foreach ($accidentes_ls as $key => $cia)
                                    <option value="{{ $key }}">
                                        {{ $cia }}
                                    </option>
                                @endforeach
        ...
        <div class="form-group col-md-6 {{ $errors->has('accidente_t') ? 'has-error' : '' }}">
            <label for="accidente_t" class="control-label">Accidente a:</label>
            <!--<div class="col-md-10">-->
                <select class="form-control chosen" id="accidente_t" name="accidente_t" required="true">
                            <option value="" style="display: none;"  disabled selected>Seleccionar</option>
                                @foreach ($accidentes_ls as $key => $cia)
                                    <option value="{{ $key }}">
                                        {{ $cia }}
