...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : '{{ trans('files_s_registros.model_plural') }}' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('files_s_registros.files_s_registro.update', $filesSRegistro->id) }}" id="edit_files_s_registro_form" name="edit_files_s_registro_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('files_s_registros.form', [
                                        'filesSRegistro' => $filesSRegistro,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('files_s_registros.update') }}">
                    </div>
                </div>
            </form>
