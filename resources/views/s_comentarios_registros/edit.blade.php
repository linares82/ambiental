...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : '{{ trans('s_comentarios_registros.model_plural') }}' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('s_comentarios_registros.s_comentarios_registro.update', $sComentariosRegistro->id) }}" id="edit_s_comentarios_registro_form" name="edit_s_comentarios_registro_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('s_comentarios_registros.form', [
                                        'sComentariosRegistro' => $sComentariosRegistro,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('s_comentarios_registros.update') }}">
                    </div>
                </div>
            </form>
