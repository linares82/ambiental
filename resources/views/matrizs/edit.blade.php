...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Matriz' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('matrizs.matriz.update', $matriz->id) }}" id="edit_matriz_form" name="edit_matriz_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            ...
            @include ('matrizs.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('matrizs.update') }}">
                    </div>
                </div>
            </form>
