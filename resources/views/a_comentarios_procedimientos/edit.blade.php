...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : '{{ trans('a_comentarios_procedimientos.model_plural') }}' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('a_comentarios_procedimientos.a_comentarios_procedimiento.update', $aComentariosProcedimiento->id) }}" id="edit_a_comentarios_procedimiento_form" name="edit_a_comentarios_procedimiento_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('a_comentarios_procedimientos.form', [
                                        'aComentariosProcedimiento' => $aComentariosProcedimiento,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('a_comentarios_procedimientos.update') }}">
                    </div>
                </div>
            </form>
