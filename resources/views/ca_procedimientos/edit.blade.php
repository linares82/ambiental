...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('ca_procedimientos.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('ca_procedimientos.ca_procedimiento.update', $caProcedimiento->id) }}" id="edit_ca_procedimiento_form" name="edit_ca_procedimiento_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('ca_procedimientos.form', [
                                        'caProcedimiento' => $caProcedimiento,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('ca_procedimientos.update') }}">
                    </div>
                </div>
            </form>
