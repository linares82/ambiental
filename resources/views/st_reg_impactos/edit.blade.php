...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : '{{ trans('st_reg_impactos.model_plural') }}' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('st_reg_impactos.st_reg_impacto.update', $stRegImpacto->id) }}" id="edit_st_reg_impacto_form" name="edit_st_reg_impacto_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('st_reg_impactos.form', [
                                        'stRegImpacto' => $stRegImpacto,
                                      ])

                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('st_reg_impactos.update') }}">
                    </div>
                </div>
            </form>
