...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : trans('tpo_docs.model_plural') }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('tpo_docs.tpo_doc.update', $tpoDoc->id) }}" id="edit_tpo_doc_form" name="edit_tpo_doc_form" accept-charset="UTF-8" class="">
            {{ csrf_field() }}
            ...
            @include ('tpo_docs.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('tpo_docs.update') }}">
                    </div>
                </div>
            </form>
